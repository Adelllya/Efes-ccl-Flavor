...
/** Общая обёртка: один viewBox и одинаковая обводка для всех иконок панели. */
...
export const PANEL_ICONS: Record<string, string> = {
  overview: svg('<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/>'),
  brands: svg('<path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"/><circle cx="12" cy="13" r="3"/>'),
  pyramid: svg('<path d="M12 3 2 20h20L12 3z"/><path d="M7.4 14h9.2"/><path d="M9.6 9.5h4.8"/>'),
  pairings: svg('<path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2"/><path d="M7 2v20"/><path d="M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3Zm0 0v7"/>'),
  notes: svg('<path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z"/><path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"/>'),
  ...
  logout: svg('<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><path d="M21 12H9"/>'),
  ...
  store: svg('<path d="M3 9 5 3h14l2 6"/><path d="M3 9h18v11a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1z"/><path d="M9 21v-6h6v6"/>'),
  ...
  layers: svg('<path d="m12 2 10 5-10 5L2 7l10-5z"/><path d="m2 12 10 5 10-5"/><path d="m2 17 10 5 10-5"/>'),
...
@Component({
  selector: 'panel-icon',
  standalone: true,
  template: `<span class="panel-icon" [class.panel-icon-lg]="size === 'lg'" [innerHTML]="html"></span>`
})
export class PanelIconComponent {
  ...
  @Input() set name(value: string) {
    this.html = this.sanitizer.bypassSecurityTrustHtml(PANEL_ICONS[value] ?? '');
  }
}
