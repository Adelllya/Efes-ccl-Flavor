...
export const DISH_NAMES: Record<string, L10n> = {
  'lagman-spicy': L('Ащы лағман', 'Spicy lagman'),
  'chak-chak': L('Шақшақ', 'Chak-chak'),
  'okroshka': L('Окрошка', 'Okroshka'),
  'weisswurst': L('Вайсвурст', 'Weisswurst'),
  'oysters-raw': L('Шикі устрицалар', 'Raw oysters'),
  'mussels-steamed': L('Буға пісірілген мидиялар', 'Steamed mussels'),
  'grilled-trout': L('Гриль бахтах', 'Grilled trout'),
  'roast-pork': L('Пеште пісірілген шошқа еті', 'Roast pork'),
  'chocolate-fondant': L('Шоколад фонданы', 'Chocolate fondant'),
  'chicken-curry': L('Тауық карриі', 'Chicken curry'),
  'cheesecake': L('Чизкейк', 'Cheesecake'),
  'burrata': L('Буррата', 'Burrata'),
  'salmon-grilled': L('Гриль албырт', 'Grilled salmon'),
  'asparagus-grilled': L('Гриль қояншөп', 'Grilled asparagus'),
  'beef-tartare': L('Сиыр етінен тартар', 'Beef tartare'),
  'cheese-aged': L('Ұзақ сақталған ірімшік / рокфор', 'Aged cheese / Roquefort'),
  'dark-chocolate': L('Қара шоколад 70%', 'Dark chocolate 70%'),
  'sorpa': L('Сорпа', 'Sorpa (broth)'),
  'nauryz-kozhe': L('Наурыз көже', 'Nauryz kozhe'),
  'baursaki-kaimak': L('Қаймақпен бауырсақ', 'Baursak with kaymak'),
  'lagman': L('Лағман', 'Lagman'),
  'manty-pumpkin': L('Асқабақ манты', 'Pumpkin manty'),
  'plov-fergana': L('Ферғана палауы', 'Fergana plov'),
  'ganfan': L('Ганфан', 'Ganfan'),
  'ashlyam-fu': L('Ашлянфу', 'Ashlyam-fu'),
  'kuyrdak-liver': L('Бауыр қуырдағы', 'Liver kuyrdak'),
  'achichuk': L('Ачичук', 'Achichuk salad'),
  'shashlyk-chicken': L('Тауық шашлығы', 'Chicken shashlyk'),
  'lyulya-kebab': L('Люля-кебаб', 'Lyulya kebab'),
  'chebureki': L('Шебұрек', 'Chebureki'),
  'pelmeni': L('Пельмен', 'Pelmeni'),
  'khinkali': L('Хинкали', 'Khinkali'),
  'khachapuri-adjarian': L('Аджар хачапуриі', 'Adjarian khachapuri'),
  'dolma': L('Долма', 'Dolma'),
  'herring-shuba': L('Тон астындағы майшабақ', 'Herring under a fur coat'),
  'olivier': L('Оливье', 'Olivier salad'),
  'borsch': L('Борщ', 'Borscht'),
  'solyanka': L('Етті солянка', 'Meat solyanka'),
  'vobla': L('Вобла (кептірілген балық)', 'Vobla (dried fish)'),
  'crayfish-boiled': L('Асылған шаян', 'Boiled crayfish'),
  'garlic-croutons': L('Сарымсақты кептірме нан', 'Garlic croutons'),
  'napoleon': L('«Наполеон» торты', 'Napoleon cake'),
  'medovik': L('Медовик', 'Medovik honey cake'),
  'baklava': L('Пахлава', 'Baklava'),
  'shawarma': L('Шаурма', 'Shawarma'),
  'fries': L('Фри картобы', 'French fries'),
  'bbq-wings': L('BBQ тауық қанаттары', 'BBQ chicken wings'),
  'cheese-plate': L('Ірімшік тәрелкесі', 'Cheese plate'),
  'cold-cuts': L('Ет турамасы', 'Cold cuts'),
  'garlic-shrimp': L('Сарымсақ тұздығындағы асшаян', 'Garlic shrimp'),
  'calamari-rings': L('Қамырдағы кальмар', 'Fried calamari rings'),
  'mozzarella-sticks': L('Ірімшік таяқшалары', 'Mozzarella sticks'),
  'salted-nuts': L('Пісте / жержаңғақ', 'Pistachios / peanuts'),
  'cheeseburger': L('Чизбургер', 'Cheeseburger'),
  'pork-knuckle': L('Шошқа сирағы', 'Pork knuckle'),
  'fish-and-chips': L('Фиш-энд-чипс', 'Fish and chips'),
  'pizza-pepperoni': L('Пепперони пиццасы', 'Pepperoni pizza'),
  'ribeye-steak': L('Рибай стейгі', 'Ribeye steak'),
  'paella': L('Паэлья', 'Paella'),
  'caesar-salad': L('Тауық еті қосылған «Цезарь» салаты', 'Chicken Caesar salad'),
  'greek-salad': L('Грек салаты', 'Greek salad'),
  'ice-cream': L('Пломбир балмұздақ', 'Plombir ice cream'),
  'philadelphia-roll': L('«Филадельфия» ролы', 'Philadelphia roll'),
  'tom-yum': L('Том ям', 'Tom yum'),
  'pad-thai': L('Пад тай', 'Pad thai'),
  'pho-bo': L('Фо бо', 'Pho bo'),
...
export const DISH_CATEGORIES: Record<string, L10n> = {
  'Лапша': L('Кеспе', 'Noodles'),
  'Суп холодный': L('Суық сорпа', 'Cold soup'),
  'Колбасы': L('Шұжықтар', 'Sausages'),
  'Морепродукты': L('Теңіз өнімдері', 'Seafood'),
  'Рыба': L('Балық', 'Fish'),
  'Овощи': L('Көкөністер', 'Vegetables'),
  'Сыры': L('Ірімшіктер', 'Cheeses'),
  'Супы': L('Сорпалар', 'Soups'),
  'Лапша (холодная)': L('Кеспе (суық)', 'Noodles (cold)'),
  'Тестовое (варёное)': L('Қамыр тағамдары (асылған)', 'Dumplings (boiled)'),
  'Выпечка': L('Нан-тоқаш', 'Pastry'),
  'Закуски к пиву': L('Сыраға тіскебасар', 'Beer snacks'),
  'Закуски': L('Тіскебасарлар', 'Starters'),
