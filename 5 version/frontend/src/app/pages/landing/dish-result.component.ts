...
import { Brand, Dish, FoodIcon, FoodPairing } from '../../models/flavor-tree.models';
import {
...
export class DishResultComponent {
  ...
  get title(): string {
    return profileTitle(this.profile);
  }
